...
class GraphqlException extends AppException {
  ...
  AppException serialize() {
    final checkUnAuthorized = errors?.any((element) => element.extensions?['code'] == '401' || element.extensions?['code'] == 'UNAUTHENTICATED' || element.extensions?['code'] == 401 || element.extensions?['code'] == 403) ?? false;
