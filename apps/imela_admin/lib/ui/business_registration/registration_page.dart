                  ...
                  child: appWidgetFactory.createCard(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        MultiInputTextfield(viewmodel: viewmodel.businessNameInputViewodel, widgetFactory: appWidgetFactory, values: Map<String, String>.from(viewmodel.inputOptions), selectedKey: viewmodel.selectedInputOptionKey.value),
                        const SizedBox(height: 16),
                        appWidgetFactory.createText(context, 'Business Description', style: Theme.of(context).textTheme.titleSmall),
                        MultiInputTextfield(viewmodel: viewmodel.businessDescriptionInputViewodel, widgetFactory: appWidgetFactory, values: Map<String, String>.from(viewmodel.inputOptions), selectedKey: viewmodel.selectedInputOptionKey.value),
                        const SizedBox(height: 16),
                        ...
                        if (viewmodel.showEmailInput.value) ...[
                          ...
                          appWidgetFactory.createTextField(controller: viewmodel.businessEmailController, hintText: 'Enter business email', onChanged: (value) {}),
                          const SizedBox(height: 16),
                        ],
                        const SizedBox(height: 24),
                        ...
                        const SizedBox(height: 24),
                        appWidgetFactory.createDropDownBeta<String>(context, options: categories, selectedValues: [categories.first], showSearch: true, onChanged: (value) {}),
